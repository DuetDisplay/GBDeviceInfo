...
+ (NSArray *)_modelNuances {
    ...
    CGFloat pixelsPerInch = 0;
        ...
        NSDictionary *modelManifest = @{
            @"iPhone": @{
                // 1st Gen
                @[@1, @1]: @[@(GBDeviceModeliPhone1), @"iPhone 1G", @(GBDeviceDisplay3p5Inch), @163],
                ...
                // SE 2
                @[@12, @8]: @[@(GBDeviceModeliPhoneSE2), @"iPhone SE (2nd Gen)", @(GBDeviceDisplay4p7Inch), @326],
            ...
            @"iPad": @{
                ...
                // mini
                @[@2, @5]: @[@(GBDeviceModeliPadMini1), @"iPad Mini (1st Gen)", @(GBDeviceDisplay7p9Inch), @163],
                @[@2, @6]: @[@(GBDeviceModeliPadMini1), @"iPad Mini (1st Gen)", @(GBDeviceDisplay7p9Inch), @163],
                @[@2, @7]: @[@(GBDeviceModeliPadMini1), @"iPad Mini (1st Gen)", @(GBDeviceDisplay7p9Inch), @163],
                ...
                // Air
                @[@4, @1]: @[@(GBDeviceModeliPadAir1), @"iPad Air (1st Gen)", @(GBDeviceDisplay9p7Inch), @264],
                @[@4, @2]: @[@(GBDeviceModeliPadAir1), @"iPad Air (1st Gen)", @(GBDeviceDisplay9p7Inch), @264],
                @[@4, @3]: @[@(GBDeviceModeliPadAir1), @"iPad Air (1st Gen)", @(GBDeviceDisplay9p7Inch), @264],

                // mini 2
                @[@4, @4]: @[@(GBDeviceModeliPadMini2), @"iPad Mini (2nd Gen)", @(GBDeviceDisplay7p9Inch), @326],
                @[@4, @5]: @[@(GBDeviceModeliPadMini2), @"iPad Mini (2nd Gen)", @(GBDeviceDisplay7p9Inch), @326],
                @[@4, @6]: @[@(GBDeviceModeliPadMini2), @"iPad Mini (2nd Gen)", @(GBDeviceDisplay7p9Inch), @326],

                // mini 3
                @[@4, @7]: @[@(GBDeviceModeliPadMini3), @"iPad Mini (3rd Gen)", @(GBDeviceDisplay7p9Inch), @326],
                @[@4, @8]: @[@(GBDeviceModeliPadMini3), @"iPad Mini (3rd Gen)", @(GBDeviceDisplay7p9Inch), @326],
                @[@4, @9]: @[@(GBDeviceModeliPadMini3), @"iPad Mini (3rd Gen)", @(GBDeviceDisplay7p9Inch), @326],

                // mini 4
                @[@5, @1]: @[@(GBDeviceModeliPadMini4), @"iPad Mini (4th Gen)", @(GBDeviceDisplay7p9Inch), @326],
                @[@5, @2]: @[@(GBDeviceModeliPadMini4), @"iPad Mini (4th Gen)", @(GBDeviceDisplay7p9Inch), @326],

                // Air 2
                @[@5, @3]: @[@(GBDeviceModeliPadAir2), @"iPad Air (2nd Gen)", @(GBDeviceDisplay9p7Inch), @264],
                @[@5, @4]: @[@(GBDeviceModeliPadAir2), @"iPad Air (2nd Gen)", @(GBDeviceDisplay9p7Inch), @264],

                // Pro 12.9-inch
                @[@6, @7]: @[@(GBDeviceModeliPadPro12p9Inch), @"iPad Pro (12.9 inch) (1st Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@6, @8]: @[@(GBDeviceModeliPadPro12p9Inch), @"iPad Pro (12.9 inch) (1st Gen)", @(GBDeviceDisplay12p9Inch), @264],

                // Pro 9.7-inch
                @[@6, @3]: @[@(GBDeviceModeliPadPro9p7Inch), @"iPad Pro (9.7 inch) (1st Gen)", @(GBDeviceDisplay9p7Inch), @264],
                @[@6, @4]: @[@(GBDeviceModeliPadPro9p7Inch), @"iPad Pro (9.7 inch) (1st Gen)", @(GBDeviceDisplay9p7Inch), @264],

                // iPad 5th Gen, 2017
                @[@6, @11]: @[@(GBDeviceModeliPad5), @"iPad (5th Gen)", @(GBDeviceDisplay9p7Inch), @264],
                @[@6, @12]: @[@(GBDeviceModeliPad5), @"iPad (5th Gen)", @(GBDeviceDisplay9p7Inch), @264],

                // Pro 12.9-inch, 2017
                @[@7, @1]: @[@(GBDeviceModeliPadPro12p9Inch2), @"iPad Pro (12.9 inch) (2nd Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@7, @2]: @[@(GBDeviceModeliPadPro12p9Inch2), @"iPad Pro (12.9 inch) (2nd Gen)", @(GBDeviceDisplay12p9Inch), @264],

                // Pro 10.5-inch, 2017
                @[@7, @3]: @[@(GBDeviceModeliPadPro10p5Inch), @"iPad Pro (10.5 inch) (2nd Gen)", @(GBDeviceDisplay10p5Inch), @264],
                @[@7, @4]: @[@(GBDeviceModeliPadPro10p5Inch), @"iPad Pro (10.5 inch) (2nd Gen)", @(GBDeviceDisplay10p5Inch), @264],

                // iPad 6th Gen, 2018
                @[@7, @5]: @[@(GBDeviceModeliPad6), @"iPad (6th Gen)", @(GBDeviceDisplay9p7Inch), @264],
                @[@7, @6]: @[@(GBDeviceModeliPad6), @"iPad (6th Gen)", @(GBDeviceDisplay9p7Inch), @264],

                // iPad 7th Gen, 2019
                @[@7, @11]: @[@(GBDeviceModeliPad7), @"iPad (7th Gen)", @(GBDeviceDisplay10p2Inch), @264],
                @[@7, @12]: @[@(GBDeviceModeliPad7), @"iPad (7th Gen)", @(GBDeviceDisplay10p2Inch), @264],

                // iPad Pro 11-inch, 2018
                @[@8, @1]: @[@(GBDeviceModeliPadPro11Inch), @"iPad Pro (11 inch) (1st Gen)", @(GBDeviceDisplay11Inch), @264],
                @[@8, @3]: @[@(GBDeviceModeliPadPro11Inch), @"iPad Pro (11 inch) (1st Gen)", @(GBDeviceDisplay11Inch), @264],

                // iPad Pro 11-inch 1TB, 2018
                @[@8, @2]: @[@(GBDeviceModeliPadPro11Inch), @"iPad Pro (11 inch) (1st Gen)", @(GBDeviceDisplay11Inch), @264],
                @[@8, @4]: @[@(GBDeviceModeliPadPro11Inch), @"iPad Pro (11 inch) (1st Gen)", @(GBDeviceDisplay11Inch), @264],

                // iPad Pro 3rd Gen 12.9-inch, 2018
                @[@8, @5]: @[@(GBDeviceModeliPadPro12p9Inch3), @"iPad Pro (12.9 inch) (3rd Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@8, @7]: @[@(GBDeviceModeliPadPro12p9Inch3), @"iPad Pro (12.9 inch) (3rd Gen)", @(GBDeviceDisplay12p9Inch), @264],

                // iPad Pro 3rd Gen 12.9-inch 1TB, 2018
                @[@8, @6]: @[@(GBDeviceModeliPadPro12p9Inch3), @"iPad Pro (12.9 inch) (3rd Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@8, @8]: @[@(GBDeviceModeliPadPro12p9Inch3), @"iPad Pro (12.9 inch) (3rd Gen)", @(GBDeviceDisplay12p9Inch), @264],

                // iPad Pro 2nd Gen 11-inch, 2020
                @[@8, @9]: @[@(GBDeviceModeliPadPro11Inch2), @"iPad Pro (11 inch) (2nd Gen)", @(GBDeviceDisplay11Inch), @264],
                @[@8, @10]: @[@(GBDeviceModeliPadPro11Inch2), @"iPad Pro (11 inch) (2nd Gen)", @(GBDeviceDisplay11Inch), @264],

                // iPad Pro 4th Gen 12.9-inch, 2020
                @[@8, @11]: @[@(GBDeviceModeliPadPro12p9Inch4), @"iPad Pro (12.9 inch) (4th Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@8, @12]: @[@(GBDeviceModeliPadPro12p9Inch4), @"iPad Pro (12.9 inch) (4th Gen)", @(GBDeviceDisplay12p9Inch), @264],

                // mini 5
                @[@11, @1]: @[@(GBDeviceModeliPadMini5), @"iPad Mini (5th Gen)", @(GBDeviceDisplay7p9Inch), @326],
                @[@11, @2]: @[@(GBDeviceModeliPadMini5), @"iPad Mini (5th Gen)", @(GBDeviceDisplay7p9Inch), @326],

                // Air 3
                @[@11, @3]: @[@(GBDeviceModeliPadAir3), @"iPad Air (3rd Gen)", @(GBDeviceDisplay10p5Inch), @264],
                @[@11, @4]: @[@(GBDeviceModeliPadAir3), @"iPad Air (3rd Gen)", @(GBDeviceDisplay10p5Inch), @264],

                // iPad 8th Gen, 2020
                @[@11, @6]: @[@(GBDeviceModeliPad8), @"iPad (8th Gen)", @(GBDeviceDisplay10p2Inch), @264],
                @[@11, @7]: @[@(GBDeviceModeliPad8), @"iPad (8th Gen)", @(GBDeviceDisplay10p2Inch), @264],

                // iPad 9th Gen, 2021
                @[@12, @1]: @[@(GBDeviceModeliPad9), @"iPad (9th Gen)", @(GBDeviceDisplay10p2Inch), @264],
                @[@12, @2]: @[@(GBDeviceModeliPad9), @"iPad (9th Gen)", @(GBDeviceDisplay10p2Inch), @264],

                // Air 4
                @[@13, @1]: @[@(GBDeviceModeliPadAir4), @"iPad Air (4th Gen)", @(GBDeviceDisplay10p9Inch), @264],
                @[@13, @2]: @[@(GBDeviceModeliPadAir4), @"iPad Air (4th Gen)", @(GBDeviceDisplay10p9Inch), @264],

                // iPad Pro 3rd Gen 11-inch, 2021
                @[@13, @4]: @[@(GBDeviceModeliPadPro11Inch3), @"iPad Pro (11 inch) (3rd Gen)", @(GBDeviceDisplay11Inch), @264],
                @[@13, @5]: @[@(GBDeviceModeliPadPro11Inch3), @"iPad Pro (11 inch) (3rd Gen)", @(GBDeviceDisplay11Inch), @264],
                @[@13, @6]: @[@(GBDeviceModeliPadPro11Inch3), @"iPad Pro (11 inch) (3rd Gen)", @(GBDeviceDisplay11Inch), @264],
                @[@13, @7]: @[@(GBDeviceModeliPadPro11Inch3), @"iPad Pro (11 inch) (3rd Gen)", @(GBDeviceDisplay11Inch), @264],

                // iPad Pro 5th Gen 12.9-inch, 2021
                @[@13, @8]: @[@(GBDeviceModeliPadPro12p9Inch5), @"iPad Pro (12.9 inch) (5th Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@13, @9]: @[@(GBDeviceModeliPadPro12p9Inch5), @"iPad Pro (12.9 inch) (5th Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@13, @10]: @[@(GBDeviceModeliPadPro12p9Inch5), @"iPad Pro (12.9 inch) (5th Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@13, @11]: @[@(GBDeviceModeliPadPro12p9Inch5), @"iPad Pro (12.9 inch) (5th Gen)", @(GBDeviceDisplay12p9Inch), @264],

                // Air 5, 2022
                @[@13, @16]: @[@(GBDeviceModeliPadAir5), @"iPad Air (5th Gen)", @(GBDeviceDisplay10p9Inch), @264],
                @[@13, @17]: @[@(GBDeviceModeliPadAir5), @"iPad Air (5th Gen)", @(GBDeviceDisplay10p9Inch), @264],

                // mini 6
                @[@14, @1]: @[@(GBDeviceModeliPadMini6), @"iPad Mini (6th Gen)", @(GBDeviceDisplay8p3Inch), @326],
                @[@14, @2]: @[@(GBDeviceModeliPadMini6), @"iPad Mini (6th Gen)", @(GBDeviceDisplay8p3Inch), @326],

                // iPad 10th Gen, 2022
                @[@13, @18]: @[@(GBDeviceModeliPad10), @"iPad (10th Gen)", @(GBDeviceDisplay10p9Inch), @264],
                @[@13, @19]: @[@(GBDeviceModeliPad10), @"iPad (10th Gen)", @(GBDeviceDisplay10p9Inch), @264],

                // iPad Pro 4th Gen 11-inch, 2022
                @[@14, @3]: @[@(GBDeviceModeliPadPro11Inch4), @"iPad Pro (11 inch) (4th Gen)", @(GBDeviceDisplay11Inch), @264],
                @[@14, @4]: @[@(GBDeviceModeliPadPro11Inch4), @"iPad Pro (11 inch) (4th Gen)", @(GBDeviceDisplay11Inch), @264],

                // iPad Pro 6th Gen 12.9-inch, 2022
                @[@14, @5]: @[@(GBDeviceModeliPadPro12p9Inch6), @"iPad Pro (12.9 inch) (6th Gen)", @(GBDeviceDisplay12p9Inch), @264],
                @[@14, @6]: @[@(GBDeviceModeliPadPro12p9Inch6), @"iPad Pro (12.9 inch) (6th Gen)", @(GBDeviceDisplay12p9Inch), @264],

                // Air M2 11-inch, 2024
                @[@14, @8]: @[@(GBDeviceModeliPadAir11Inch6), @"iPad Air (11 inch) (M2)", @(GBDeviceDisplay11Inch), @264],
                @[@14, @9]: @[@(GBDeviceModeliPadAir11Inch6), @"iPad Air (11 inch) (M2)", @(GBDeviceDisplay11Inch), @264],

                // Air M2 13-inch, 2024
                @[@14, @10]: @[@(GBDeviceModeliPadAir13Inch6), @"iPad Air (13 inch) (M2)", @(GBDeviceDisplay13Inch), @264],
                @[@14, @11]: @[@(GBDeviceModeliPadAir13Inch6), @"iPad Air (13 inch) (M2)", @(GBDeviceDisplay13Inch), @264],

                // Air M3, 11-inch, 2025
                @[@15, @3]: @[@(GBDeviceModeliPadAir11Inch7), @"iPad Air (11 inch) (M3)", @(GBDeviceDisplay11Inch), @264],
                @[@15, @4]: @[@(GBDeviceModeliPadAir11Inch7), @"iPad Air (11 inch) (M3)", @(GBDeviceDisplay11Inch), @264],

                // Air M3, 13-inch, 2025
                @[@15, @5]: @[@(GBDeviceModeliPadAir13Inch7), @"iPad Air (13 inch) (M3)", @(GBDeviceDisplay13Inch), @264],
                @[@15, @6]: @[@(GBDeviceModeliPadAir13Inch7), @"iPad Air (13 inch) (M3)", @(GBDeviceDisplay13Inch), @264],

                // iPad 11th Gen, 2025
                @[@15, @7]: @[@(GBDeviceModeliPad11), @"iPad (11th Gen)", @(GBDeviceDisplay10p9Inch), @264],
                @[@15, @8]: @[@(GBDeviceModeliPad11), @"iPad (11th Gen)", @(GBDeviceDisplay10p9Inch), @264],

                // Mini 7, 2024
                @[@16, @1]: @[@(GBDeviceModeliPadMini7), @"iPad Mini (7th Gen)", @(GBDeviceDisplay8p3Inch), @326],
                @[@16, @2]: @[@(GBDeviceModeliPadMini7), @"iPad Mini (7th Gen)", @(GBDeviceDisplay8p3Inch), @326],

                // iPad Pro 5th Gen 11-inch, 2024
                @[@16, @3]: @[@(GBDeviceModeliPadPro11Inch5), @"iPad Pro (11 inch) (M4)", @(GBDeviceDisplay11Inch), @264],
                @[@16, @4]: @[@(GBDeviceModeliPadPro11Inch5), @"iPad Pro (11 inch) (M4)", @(GBDeviceDisplay11Inch), @264],

                // iPad Pro 7th Gen 13-inch, 2024
                @[@16, @5]: @[@(GBDeviceModeliPadPro12p9Inch7), @"iPad Pro (13 inch) (M4)", @(GBDeviceDisplay13Inch), @264],
                @[@16, @6]: @[@(GBDeviceModeliPadPro12p9Inch7), @"iPad Pro (13 inch) (M4)", @(GBDeviceDisplay13Inch), @264],
            },
            @"iPod": @{
                // 1st Gen
                @[@1, @1]: @[@(GBDeviceModeliPod1), @"iPod Touch (1st Gen)", @(GBDeviceDisplay3p5Inch), @163],

                // 2nd Gen
                @[@2, @1]: @[@(GBDeviceModeliPod2), @"iPod Touch (2nd Gen)", @(GBDeviceDisplay3p5Inch), @163],

                // 3rd Gen
                @[@3, @1]: @[@(GBDeviceModeliPod3), @"iPod Touch (3rd Gen)", @(GBDeviceDisplay3p5Inch), @163],

                // 4th Gen
                @[@4, @1]: @[@(GBDeviceModeliPod4), @"iPod Touch (4th Gen)", @(GBDeviceDisplay3p5Inch), @326],

                // 5th Gen
                @[@5, @1]: @[@(GBDeviceModeliPod5), @"iPod Touch (5th Gen)", @(GBDeviceDisplay4Inch), @326],

                // 6th Gen
                @[@7, @1]: @[@(GBDeviceModeliPod6), @"iPod Touch (6th Gen)", @(GBDeviceDisplay4Inch), @326],

                // 7th Gen
                @[@9, @1]: @[@(GBDeviceModeliPod7), @"iPod Touch (7th Gen)", @(GBDeviceDisplay4Inch), @326],
            },
        };
